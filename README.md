...
this project is for improving the first-ML-project which we were used one variable for prediction.
in this project we used multiple independent variables to have better prediction about co2emission
# dataset source
